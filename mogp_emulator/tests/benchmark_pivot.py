...
def run_model(n_simulations, n_testing):
    ...
    gp = GaussianProcess(inputs, targets, None)
    gp.learn_hyperparameters()
    
    print("fitting pivoted GP")
    
    gp_pivot = GaussianProcess(inputs, targets, -1.)
    gp_pivot.learn_hyperparameters()
    ...
    test_vals_pivot, unc_pivot, deriv = gp_pivot.predict(testing, do_deriv = False, do_unc = True)
